...
let parser = ArgumentParser(commandName: "TeamRelativeValues", usage: "filename [--hitters  fangraphs-hitter-projections.csv --pitchers fangraphs-pitcher-projections.csv --auction auction-values.csv]", overview: "Takes a scrape of the league rosters and adds the values for all the players on their team.")
