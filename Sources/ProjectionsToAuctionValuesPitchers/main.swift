...
let nextYearProjectionFilenameString = "Zips-projections-2022-pitchers.csv"
let followingYearProjectionFilenameString = "Zips-projections-2023-pitchers.csv"

let nextYearAuctionValuesFilenameString = "Zips-auction-values-2022-pitchers.csv"
let followingYearAuctionValuesFilenameString = "Zips-auction-values-2023-pitchers.csv"
